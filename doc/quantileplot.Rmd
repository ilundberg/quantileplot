...
The `quantileplot` package is available via GitHub: first install the `devtools` package and then type `devtools::install_github("ilundberg/quantileplot")`. There is a companion working paper.
